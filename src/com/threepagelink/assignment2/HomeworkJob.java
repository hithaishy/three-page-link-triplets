...
public class HomeworkJob {
    ...
    // private static final Log LOG = LogFactory.getLog("com.threepagelink.assignment2.HomeworkJob");

    public static void main(String[] args) throws Exception {

        FileUtil.fullyDelete(new File(new Path(args[1] + "_partial").toString()));
        FileUtil.fullyDelete(new File(new Path(args[1]).toString()));

        Job job = new Job();

        /* Autogenerated initialization. */
        initJob(job, com.threepagelink.assignment2.HomeworkMapper.class, com.threepagelink.assignment2.HomeworkReducer.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path(args[1] + "_partial"));
        ...
        if (job.waitForCompletion(true)) {
            ...
            /* Autogenerated initialization. */
            initJob(job, com.threepagelink.assignment2.HomeworkMapper.class, com.threepagelink.assignment2.HomeworkReducer2.class);
            ...
            /* This is an example of how to set input and output. */
            FileInputFormat.setInputPaths(job, args[1] + "_partial");
